...
<%--                <a href="javascript:;" class="firstpage  pbtn"><img src="/resources/img/btn_firstpage.png" alt="첫 페이지로 이동"></a>--%>
                <c:if test="${pageResponseDTO.prev}">
                    <a href="javascript:;" class="prevpage pbtn" data-num="${pageResponseDTO.start-1}"><img src="/resources/img/btn_prevpage.png" alt="이전 페이지로 이동"></a>
                </c:if>
                ...
                <c:if test="${pageResponseDTO.next}">
                    <a href="javascript:;" class="nextpage pbtn" data-num="${pageResponseDTO.end+1}"><img src="/resources/img/btn_nextpage.png" alt="다음 페이지로 이동"></a>
                </c:if>
