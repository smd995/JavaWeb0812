	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<ul class="bbsview_list">
				<li class="bbs_title"><input type="text" size="110" name="title" value="${dto.title}"></li>
			...
			<div class="btn_line txt_right" style="margin: 2px;">
				<button class="btn_bbs">수정</button>
